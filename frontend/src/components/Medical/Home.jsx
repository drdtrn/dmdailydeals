...
import { WebPageSchema } from "../SEO/JsonLd";
...
function Home() {
  ...
  return (
    <>
      <MetaTags
        // Since in this current project there is no DataBase table connected to the content of the home-page,
        // i only added some placeholders explaining briefly about what each tag should containg.
        // I will make sure to add a file that explains in more detail each of the meta tags.
        // Read the Meta Tags for SEO performance pdf.
        tabTitle={"Home - My Website"}
        tabDescription={
          "Keep it between 150-160 characters, include keywords, and make it compelling."
        }
        tabKeywords={"Relevant keywords"}
        tabCanonicalHref={"https://dmdailydeals.com/"}
        authorName={"Dardan Ternava"}
        appName={"My awesome website"}
        tabOgTitle={"same as tabTitle above"}
        tabOgDescription={""}
        tabOgImg={"hero img url"}
        tabOgUrl={"current tab url"}
        tabOgType // "website" for homepages, "article" for blog posts. Default is "website".
        tabOgSitename={"same as appName"}
        twitterSummaryCard={"same as tabOgImg"}
        twitterTitle={"same as tabTitle above"}
        twitterDescription={"same as description"}
        twitterImage={"same as tabOgImg"}
      >
        <WebPageSchema
          pageTag={"Home"}
          schemaDescription={"like tabDescription"}
          schemaUrl={"current tab url"}
        />
      </MetaTags>

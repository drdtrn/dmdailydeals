...
function CategoryFilteredProducts() {
  ...
  const { products, loading, error } =
    useGetProductsByCategory(productCategory);
  ...
  return (
    <>
      <MetaTags
        tabTitle={`${productCategory.toUpperCase()} - My Website`}
        tabDescription={""}
        tabKeywords={""}
        tabCanonicalHref={""}
        authorName={""}
      ...
      <div className="bg-rock-200 w-full pt-15 lg:pt-5 flex-row justify-center items-center flex-grow mt-[5rem] lg:mt[0rem]">
        <h2 className="text-center font-mono font-extrabold text-[2rem] lg:text-[2.2rem]">
